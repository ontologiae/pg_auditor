...
let parseAllQueries filepath =
        ...
        let queriesInfoQuerystr = List.filter_map (fun q -> let res = getOneParsableQuery q in O.bind res (fun e -> Some(q,e)))  queriesInfo in 
        ...
        let _ = Printf.eprintf "Recup AST OK \n%!" in
        ...
        let _ = Printf.eprintf "Traitement AST OK \n%!" in
